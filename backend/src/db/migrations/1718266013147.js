module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('portfolios', 'artistId', {
        transaction,
      });

      await queryInterface.removeColumn('pages', 'artistId', { transaction });

      await queryInterface.removeColumn('messages', 'artistId', {
        transaction,
      });

      await queryInterface.removeColumn('exhibitions', 'artistId', {
        transaction,
      });

      await queryInterface.removeColumn('users', 'artistId', { transaction });

      await queryInterface.removeColumn('roles', 'globalAccess', {
        transaction,
      });

      await queryInterface.removeColumn('artists', 'name', { transaction });
      ...
      await queryInterface.removeColumn('exhibitions', 'end_date', {
        transaction,
      });

      await queryInterface.removeColumn('exhibitions', 'start_date', {
        transaction,
      });
