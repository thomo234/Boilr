...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/artists/artistsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureArtistsCols';
...
const TableSampleArtists = ({
  ...
  useEffect(() => {
    if (artistsNotify.showNotification) {
      notify(artistsNotify.typeNotification, artistsNotify.textNotification);
    }
  }, [artistsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/artists/artists-view/?id=${id}`);
  };
...
export default TableSampleArtists;
