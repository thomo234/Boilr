...
const MessagesTablesPage = () => {
  ...
  const [filters] = useState([
    ...
    { label: 'Sender', title: 'sender' },
    { label: 'Receiver', title: 'receiver' },
  ]);

  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_MESSAGES');
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/messages/messages-table'}>Switch to Table</Link>
          </div>
        </CardBox>
