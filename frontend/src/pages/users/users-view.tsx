    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Artists</p>

            <p>{users?.artist?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Messages Sender</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.messages_sender &&
                      Array.isArray(users.messages_sender) &&
          ...
          <>
            <p className={'block font-bold mb-2'}>Messages Receiver</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.messages_receiver &&
                      Array.isArray(users.messages_receiver) &&
                      users.messages_receiver.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.messages_receiver?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
